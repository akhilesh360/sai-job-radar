...
const excludedTitle = /\b(?:director|manager|head of|vp|vice president|chief|cto|cio|intern(?:ship)?|co-?op|apprentice|student|fellow|professor|recruiter|sales representative|sales development|account executive|account manager|evangelist|instructor|teacher|trainer|clerk|technician|electrician|mechanical|electrical|civil|structural|hvac|data center|data centre|datacenter|data entry|warehouse (?:associate|worker|operations|specialist|lead|supervisor|clerk|coordinator)|forklift|nurse|nursing|rn|lpn|clinical|oncology|registrar|coder|coding specialist|abstractor|drug|annotation|annotator|labeling|labeler|transcription|(?<!data )quality engineer|virtual desktop|vdi|field service|maintenance|janitor|driver|cashier|receptionist|paralegal)\b/i;
